...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    ...
    $extension = '';
    $ruta = 'https://snippetssammy.000webhostapp.com/snippets/api/loginRegistro/foto_perfil'; // donde se guardara
    ...
    if ($archivo != '') {
        ...
        $ruta = 'https://snippetssammy.000webhostapp.com/snippets/api/loginRegistro/foto_perfil/perfil.png';
    }
